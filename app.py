...
with st.sidebar:
    ...
    omaisuuden_myynti = st.number_input("Myyntitulo (€)", min_value=0.0, max_value=investointi, value=100_000.0, step=10_000.0)
    ...
    kassavirta_kk = st.number_input("Menetetyn omaisuuden kassavirta (€/kk)", min_value=0.0, value=0.0, step=100.0)
...
ml_ilman = laske_kustannukset_50v(investointi, 0, laina_aika, korko, sahkon_hinta, sahkon_kulutus,
                                   korjaus_vali, korjaus_hinta, korjaus_laina_aika, sahkon_inflaatio)
ml_myynnilla = laske_kustannukset_50v(investointi, omaisuuden_myynti, laina_aika, korko, sahkon_hinta, sahkon_kulutus,
                                       korjaus_vali, korjaus_hinta, korjaus_laina_aika, sahkon_inflaatio)
...
st.markdown("### Vastikkeet €/m²/v (valitut vuodet)")
...
st.dataframe(
    ...
    height=min(600, 40 + 24 * len(rivit))
)
